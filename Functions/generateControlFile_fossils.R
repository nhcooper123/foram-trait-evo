# Generate control file for fossil BAMM
# Simple modification of BAMMTools generateControlFile function
# Generates a template control file for fossil BAMM

# See http://bamm-project.org

generateControlFile_fossils <- function(file = "controlfile.txt", type = "diversification", params = NULL) {
	
	templates <- list(diversification = 
	'# Fossil BAMM configuration file for speciation/extinction analysis 
	# ==========================================================
	#
	# Format
	# ------
	...
	################################################################################
	# FOSSIL BAMM ADDITIONAL PARAMETERS
	################################################################################
	...
	# this parameter is likely to blame and needs to be modified.
	...
	trait = '
	# Fossil BAMM configuration file for phenotypic analysis
	# ===============================================
	#
	# Format
	# ------
